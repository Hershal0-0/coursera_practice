...
class Contact extends Component{
    ...
    handleSubmit(event){
        ...
        alert("Form Submitted Successfully With details:" +JSON.stringify(this.state.filter(x=>x!=="touched")))
    ...
    validate(firstname,lastname,telnum,email){
        ...
        errors.firstname="Last Name should b egreater than 3 characters"
                    ...
                    <Form>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                ...
                                placeholder="Enter Your Telephone Number" value={this.state.telnum}
                                 onChange={this.handleInputChange}
                                 valid = {errors.telnum === ''}
                            ...
                            <Col md={{size:6, offset:2}} >
                                <FormGroup check>
                                    <Label check>
                                        ...
                                        {' '}<strong>May We COntact Your</strong>
                                    </Label>
                                </FormGroup>
                            </Col>
